<template>
  ...
  <h2>Kontakt:</h2>
  <p>
    Telefon: 01590-8177010<br />
    E-Mail:
    <a href="mailto:paul@degemann.de">paul@degemann.de</a>
  </p>
  <h2>Umsatzsteuer-ID:</h2>
  <p>Umsatzsteuer-Identifikationsnummer gemäß §27a Umsatzsteuergesetz: DE335764208<br /><br /></p>
