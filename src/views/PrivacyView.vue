<template>
  <h1>Datenschutz</h1>
  <span class="privacy-content" data-v-29c2beb3="">
    <p>
    ...
    <ul>
      ...
      <li><p>zur Optimierung unserer Website.</p></li>
    </ul>
    <p>
    ...
    <p>
      ...
      sind. Dies ist für die Daten, die der Bereitstellung der Website dienen, grundsätzlich der
    ...
    <p>
      ...
      Nutzer anonymisiert, sodass eine Zuordnung des aufrufenden Clients nicht mehr möglich ist.
    </p>
    ...
    <p>
      ...
      Services nicht verfügbar oder eingeschränkt sein. Aus diesem Grund ist ein Widerspruch
      ausgeschlossen.
    </p>
    <h2>Cookies</h2>
    <p>
    ...
    <p>
      ...
      erhalten Sie Informationen und Anleitungen, wie diese Cookies gelöscht oder deren Speicherung
      vorab blockiert werden können. Je nach Anbieter Ihres Browsers finden Sie die notwendigen
    ...
    <ul>
      ...
      <li>
        <p>
          Opera:&nbsp;
          <a href="http://www.opera.com/de/help" rel="noopener noreferrer nofollow">
    ...
    <p>
      Die Bereitstellung der vorgenannten personenbezogenen Daten ist weder gesetzlich noch
      vertraglich vorgeschrieben. Ohne diese Daten ist jedoch der Dienst und die Funktionsfähigkeit
      unserer Website nicht gewährleistet. Zudem können einzelne Dienste und Services nicht
    ...
    <p>
      Des Weiteren setzen wir Cookies ein, um das Angebot auf unserer Website besser auf die
      Interessen unserer Besucher abzustimmen oder auf Basis statistischer Auswertungen allgemein zu
      verbessern.
    </p>
    <p>
      Welche Anbieter Cookies setzen, entnehmen Sie bitte den unten aufgeführten Informationen zu
      den eingesetzten Darstellungs-, Tracking-, Remarketing- und Webanalyse-Technologien.
    </p>
    ...
    <h3>Bereitstellung vorgeschrieben oder erforderlich:</h3>
    <p>
      Natürlich können Sie unsere Website grundsätzlich auch ohne Cookies betrachten. Webbrowser
    ...
    <p>
      Bitte beachten Sie, dass einzelne Funktionen unserer Website möglicherweise nicht
    ...
    <p>
      ...
      in das Kontaktformular eingegebenen Daten zur Durchführung vorvertraglicher Maßnahmen (Art. 6
      Abs. 1 lit. b DSGVO).
    </p>
    <h3>Empfänger:</h3>
    ...
    <p>
      Soweit Sie ihre Einwilligung gegeben haben, wird auf dieser Website Google Analytics
      eingesetzt, ein Webanalysedienst der Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA
      94043 USA (nachfolgend: „Google“). Google Analytics verwendet sog. „Cookies“, also
      Textdateien, die auf Ihrem Computer gespeichert werden und die eine Analyse der Benutzung der
      Webseite durch Sie ermöglichen. Die durch das Cookie erzeugten Informationen über Ihre
      Benutzung dieser Webseite werden in der Regel an einen Server von Google in den USA übertragen
      und dort gespeichert. Aufgrund der Aktivierung der IP-Anonymisierung auf diesen Webseiten,
      ...
      übertragen und dort gekürzt. Die im Rahmen von Google Analytics von Ihrem Browser übermittelte
      IP-Adresse wird nicht mit anderen Daten von Google zusammengeführt.
    </p>
    <p>
      Nähere Informationen zu Nutzungsbedingungen und Datenschutz finden Sie unter&nbsp;
      <a href="https://www.google.com/analytics/terms/de.html" rel="noopener noreferrer nofollow">
      ...
      <a href="https://policies.google.com/?hl=de" rel="noopener noreferrer nofollow">
    ...
    <h3>Widerruf der Einwilligung:</h3>
    <p>
      Sie können das Tracking durch Google Analytics auf unserer Website unterbinden, indem
      Sie&nbsp;
      <a href="https://degemann.de/privacy/#" rel="noopener noreferrer nofollow">
        diesen Link anklicken
      </a>
      . Dabei wird ein Opt-out-Cookie auf Ihrem Gerät installiert. Damit wird die Erfassung durch
      Google Analytics für diese Website und für diesen Browser zukünftig verhindert, solange das
      Cookie in Ihrem Browser installiert bleibt.
    </p>
    <p>
      Sie können darüber hinaus die Speicherung der Cookies durch eine entsprechende Einstellung
    ...
    <p>
      ...
      <a href="http://tools.google.com/dlpage/gaoptout?hl=de" rel="noopener noreferrer nofollow">
    ...
    <p>
      ...
      <a href="https://developers.google.com/fonts/faq" rel="noopener noreferrer nofollow">
        https://developers.google.com/fonts/faq
      </a>
      &nbsp;und in der Datenschutzerklärung von Google:&nbsp;
      <a href="https://www.google.com/policies/privacy/" rel="noopener noreferrer nofollow">
    ...
    <p>
      <a href="mailto:info@degemann.de"> Datenschutzbeauftrager </a>
    </p>
    <p>
      <em>
